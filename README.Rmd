...
* Navigate your file system.
* Modify your file system: Create/copy/move, and remove (!) files/directories.
...
* Option 1: You can get a bash terminal following Appendix A of Happy Git with
R: [The shell](https://happygitwithr.com/shell.html#shell). Then download the
[example
...
* Option 2: Use the docker image `maurolepore/terminal` including the example
data with:
